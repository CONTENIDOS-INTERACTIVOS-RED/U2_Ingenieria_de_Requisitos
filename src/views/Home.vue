        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 2 del curso "Ingeniería de requisitos" profundiza en el análisis, documentación y priorización de requisitos en el desarrollo de software. Se abordan requisitos funcionales (acciones del sistema) y no funcionales (condiciones de operación), su correcta identificación, validación y documentación en un SRS. También se detallan técnicas cualitativas y cuantitativas para su priorización, enfocadas en entregar valor al negocio. La participación de los stakeholders es esencial. La unidad fortalece habilidades claves para garantizar productos de software eficientes, útiles y alineados con los objetivos del cliente.
